...
export default function UpcomingTestsPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900">Upcoming Tests</h1>
        <p className="mt-1 text-sm text-slate-500">All tests scheduled for your batches.</p>
      </div>
      ...
      {tests && tests.length === 0 && (
        <div className="rounded-2xl border-2 border-dashed border-slate-200 p-16 text-center">
          <p className="text-slate-500 font-medium">No upcoming tests.</p>
