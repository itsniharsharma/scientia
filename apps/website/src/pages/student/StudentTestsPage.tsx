...
export function StudentTestsPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">My Tests</h1>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">All tests scheduled for you.</p>
      </div>
      ...
      {tests && tests.length === 0 && (
        <div className="rounded-2xl border-2 border-dashed border-slate-200 p-16 text-center dark:border-slate-700">
          <p className="text-slate-500 font-medium dark:text-slate-300">No scheduled tests yet.</p>
